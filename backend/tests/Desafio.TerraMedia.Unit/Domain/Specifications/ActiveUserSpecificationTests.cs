...
using Desafio.TerraMedia.Domain.Specifications;
using Desafio.TerraMedia.Unit.Domain.Specifications.TestData;
using FluentAssertions;
using Xunit;

namespace Desafio.TerraMedia.Unit.Domain.Specifications
{
